...
class DashboardClassView(ListView):
    ...
    def get_queryset(self):
        ...
        self.extra_context = {
            ...
            "title": "Dashboard",
            "contributor": "WeeAI Team",
            "content": "Dashboard, a place to see the overview of the data in WeeAI. You can see the number of data uploaded by each user, the number of segmented and unsegmented data, the color distribution of the images, and the number of segmentations for each segmentation type.",
            "app_css": "myapp/css/styles.css",
            "app_js": "myapp/js/scripts.js",
            "logo": "myapp/images/Logo.png",
